...
from nlc_dino_runner.utils.constants import RUNNING, DUCKING, JUMPING, RUNNING_SHIELD, DUCKING_SHIELD, \
    JUMPING_SHIELD, DEFAULT_TYPE, SHIELD_TYPE, HAMMER_TYPE, JUMPING_HAMMER, DUCKING_HAMMER, RUNNING_HAMMER
